...
class ControllerExtensionFeedMultifeed extends Controller {
 		...
 		if (isset($this->error['warning'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/feed/multifeed', 'user_token=' . $this->session->data['user_token'], true),
      		'separator' => ' :: '
   		);

		
		$data['action'] = $this->url->link('extension/feed/multifeed', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function category() {
		...
		$pagination->limit = 5;
		$pagination->url = $this->url->link('extension/feed/multifeed/category', 'user_token=' . $this->session->data['user_token'] . '&platform=' . $categorId . '&page={page}', true);
